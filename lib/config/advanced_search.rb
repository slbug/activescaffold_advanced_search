module ActiveScaffold::Config
  ...
  class AdvancedSearch < Base
    ...
    cattr_accessor :link
    @@link = ActiveScaffold::DataStructures::ActionLink.new('show_advanced_search', :label => 'Advanced Search', :type => :collection, :position => :top, :security_method => :advanced_search_authorized?)
